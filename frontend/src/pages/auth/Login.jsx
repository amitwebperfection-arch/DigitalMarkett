...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-primary-50 flex items-center justify-center p-3">
      {/* Subtle background accent */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-primary-400 via-primary-600 to-primary-800" />
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link to="/forgot-password" className="text-xs text-primary-500 hover:text-primary-700 font-medium transition-colors">
                  Forgot?
                </Link>
              </div>
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="checkbox"
                className="w-3.5 h-3.5 rounded border-primary-300 text-primary-600 focus:ring-primary-200"
              />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-2.5 bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold rounded-lg transition-all shadow-md shadow-primary-200 hover:shadow-lg hover:shadow-primary-300 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
            >
              {isLoading ? (
